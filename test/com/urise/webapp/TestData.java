        ...
        R1.addSection(SectionType.EXPERIENCE,
                new CompanySection(
                        new Company("Organization11", "http://Organization11.ru",
                                new Company.Position(2005, Month.JANUARY, "position1", "content1"),
                                new Company.Position(2001, Month.MARCH, 2005, Month.JANUARY, "position2", "content2"))));
        R1.addSection(SectionType.EXPERIENCE,
                new CompanySection(
                        new Company("Organization2", "http://Organization2.ru",
                                new Company.Position(2015, Month.JANUARY, "position1", "content1"))));
